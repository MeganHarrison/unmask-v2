...
import { TextsDataTableEditable } from "@/components/table/texts-data-table-editable"
...
export default function Page() {
  ...
  const fetchTextsData = async (page: number = 1, limit: number = 500) => {
